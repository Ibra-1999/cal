document.addEventListener('DOMContentLoaded',()=>{
    ...
    const txtFinalCashIWords = document.getElementById('txtFinalCashInWords');
    ...
    function totalCash() {
        ...
        txtFinalCashIWords.textContent = `Total Cash In Words: ${convertToWords(totalCashValue)}`;
    }
